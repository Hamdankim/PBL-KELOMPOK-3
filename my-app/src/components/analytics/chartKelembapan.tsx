      ...
      <div className="flex justify-between items-center mb-4">
        ...
        <div className="flex rounded-lg p-1" style={{ background: "var(--bg-600)" }}>
          <button
            ...
            className={`px-3 py-1 text-sm rounded-md transition-colors ${timeRange === 1 ? "bg-green-500 text-white" : "text-[var(--text-muted)]"}`}
          >
            1 Hari
          </button>
          <button
            onClick={() => setTimeRange(7)}
            className={`px-3 py-1 text-sm rounded-md transition-colors ${timeRange === 7 ? "bg-green-500 text-white" : "text-[var(--text-muted)]"}`}
          >
            7 Hari
          </button>
        </div>
